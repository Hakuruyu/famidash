...
$(TMPDIR)/BUILD_FLAGS.s: BUILD_FLAGS.h UTILS/defines_to_asm.py
	$(PYTHON) UTILS/defines_to_asm.py BUILD_FLAGS.h

$(TMPDIR)/C_defines.s: SAUCE/defines/*_defines.h UTILS/defines_to_asm.py
	$(PYTHON) UTILS/defines_to_asm.py SAUCE/defines/space_defines.h SAUCE/defines/physics_defines.h SAUCE/defines/level_defines.h
